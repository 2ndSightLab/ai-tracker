...
|     |     |     Resources:
|     |     |____ 🔴 KMS AMI Key
|     |     |____ 🔴 KMS Extenal AMI Share Key
|     |     |
|     |     |____ region: us-east-2
|     |           |     Resources:
|     |           |____ 🟢 account (xxxxxxxx)
...
|____ 🔴 env: work-dev
|     |
|     |____ 🔴 account: work-dev-iam
|     |     |
|     |     |     Resources:
|     |     |____ 🔴 Iadmin user
|     |     |____ 🔴 Xadmin user
|     |
|     |____ 🔴 account: work-dev-kms
|     |     |
|     |     |     Resources:
|     |     |____ 🔴 KMS Logs Key
|     |     |____ 🔴 KMS Config Key
...
|     |
|     |____ 🔴 account: work-dev-work
|     |     |
|     |     |     Resources:
|     |     |____ 🔴 IPAM EIP allocation
|     |     |____ 🔴 Base Amazon Linux ENI
|     |     |____ 🔴 Base Amazon Linux Instance
|     |     |____ 🔴 Base Amazon Linux Instance Role
|     |     |____ 🔴 Base Ubuntu Instance Role
|     |     |____ 🔴 Base Ubuntu ENI
|     |     |____ 🔴 Base Ubuntu Instance
|     |     |____ 🔴 Collab ENI
|     |     |____ 🔴 Collab Instance Role
|     |     |____ 🔴 Collab Instance
|     |     |____ 🔴 SSH Security Group
|     |     |____ 🔴 RDP Security Group
|     |
|     |____ 🔴 account: work-dev-jobs
|     |
|     |____ 🔴 account: work-dev-repo
|     |     |
|     |     |     Resources:
|     |     |____ 🔴 Code Commit Repository
|     |
|     |____ 🔴 account: work-dev-jobs-auth
|     |     |
|     |     |     Resources:
|     |     |____ 🔴 Job List Lambda
|     |     |____ 🔴 Job Invoke Lambda
|     |     |____ 🔴 Job Deploy Lambda
|     |     |____ 🔴 API Gateway
|     |     |____ 🔴 API Gateway CNAME
|     |     |____ 🔴 Yubikey Lambda Layer
|     |     |____ 🔴 fido2 Python Layer
|     |     |____ 🔴 Yubikey Register lambda + DynamoDB
|     |     |____ 🔴 Yubikey Auth lambda
|     |
|     |____ 🔴 account: work-dev-domains
|
|____ 🔴 env: work-test
|     |
...
|     |
|     |____ 🔴 account: work-test-pentest-vvowq2vlse5jxb8xalg
|           |
|           |     Resources:
...
|____ 🔴 env: work-prod
      |
      |____ 🔴 account: work-prod-iam
      |     |
      |     |     Resources:
      |     |____ 🔴 Iadmin user
      |     |____ 🔴 Xadmin user
      |
      |____ 🔴 account: work-prod-kms
      |     |
      |     |     Resources:
      |     |____ 🔴 KMS Logs Key
      |     |____ 🔴 KMS Config Key
      ...
      |     |____ 🔴 KMS Extenal AMI Share Key
      |
      |____ 🔴 account: work-prod-network
      |     |
      |     |     Resources:
      |     |____ 🔴 Remote access prefix list
      |     |____ 🔴 VPC Flow Logs Role
      ...
      |     |____ 🔴 RDP Security Group
      |
      |____ 🔴 account: work-prod-jobs
      |
      |____ 🔴 account: work-prod-repo
      |     |
      |     |     Resources:
      |     |____ 🔴 Code Commit Repository
      |
      |____ 🔴 account: work-prod-jobs-auth
      |     |
      |     |     Resources:
      |     |____ 🔴 Job List Lambda
      |     |____ 🔴 Job Invoke Lambda
